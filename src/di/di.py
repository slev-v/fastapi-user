...
from src.di.providers import (get_user_by_cookie, provide_hasher_password,
                              provide_jwt_service, provide_user_repo)
from src.di.stub import (get_session_stub, get_user_by_cookie_stub,
...
def init_dependencies(app: FastAPI, config: WebConfig):
    ...
    app.dependency_overrides[provide_jwt_service_stub] = provide_jwt_service
    app.dependency_overrides[get_user_by_cookie_stub] = get_user_by_cookie
